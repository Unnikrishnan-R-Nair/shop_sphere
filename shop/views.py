...
KEY_ID = "rzp_test_VYcmpZydAKdYYB"
KEY_SECRET = "J6sItDgXqeMId7lAME8ILJ6E"
...
class CheckOutView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if payment_mode == "cod":
            ...
            #   {'id': 'order_Nzbcbm2Jo6vfPk', 'entity': 'order', 'amount': 619700, 'amount_paid': 0, 'amount_due': 619700, 
            #       'currency': 'INR', 'receipt': 'order_rcptid_11', 'offer_id': None, 'status': 'created', 'attempts': 0, 
            #       'notes': [], 'created_at': 1713338629
            #   }
